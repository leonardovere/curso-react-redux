...
export default _ => (
    <div id="app">
        ...
        <div className="cards">
            <Card titulo="#12 - Desafio: Sorteio da megasena" color="#401801">
                <Sorteio />
            </Card>

            <Card titulo="#12 - Desafio: Contador (Baseado em Classe)" color="#730A26">
                <Contador inicial={Math.round(Math.random() * 100)} pulo={Math.round(Math.random() * 10)} />
            </Card>

            <Card titulo="#11 - Exercício: Comunicacao Controlada (Input)" color="#0554F2">
                <Input />
            </Card>
